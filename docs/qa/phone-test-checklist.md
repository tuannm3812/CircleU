...
The current beta does not require a production backend for phone testing. CloudKit work should be tested separately through service and mapping tests until real sync is intentionally enabled.
